...
val arcModuleName = "KotlinChronicleSpringBootSample"
...
val generateArcProxies by tasks.registering(JavaExec::class) {
    group = "verification"
    description = "Generates TypeScript proxies from the Kotlin Chronicle sample's KSP manifest"
...
tasks.named<BootJar>("bootJar") {
    archiveFileName.set("arc-kotlin-chronicle-sample.jar")
}
