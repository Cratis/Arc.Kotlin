 ...
 *
 * No command or query references this type. KSP discovers it from the typed factory return below;
 * the anonymous object's body is not inspected and no explicit export annotation is needed.
 */
