...
The Arc plugin supplies KSP option `arc.validationClasspath` for each compilation: sorted absolute
...
and ContractTests build configurations linked from [manual validation tooling](validation.md#manual-build-tooling).
