...
| `ARCKSP0108` | `@AllowAnonymous` combined with `@Authorize`/`@Roles` on the same declaration. Splitting them across a class and its operation is a supported override, not this error |
