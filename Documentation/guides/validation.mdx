...
`@cratis/fundamentals` to **7.19.3**, React to **19.2.8**, and TypeScript to **7.0.2**, running on
...
edge; Java uses a field, bean getter or record component, and the Java tab shows the record-component form:
