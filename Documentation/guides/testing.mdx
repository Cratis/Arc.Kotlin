...
<ArcBackendTabs snippet="guides/testing/execute" variants="kotlin,java" />
...
<ArcBackendTabs snippet="guides/testing/tenant-resolution" variants="kotlin,java" />
...
<ArcBackendTabs snippet="guides/testing/pin-read-model" variants="kotlin,java" />
...
<ArcBackendTabs snippet="guides/testing/absent-read-model" variants="kotlin,java" />
...
The Java tabs above use `BlockingCommandScenario`, a closeable bridge over a configured `CommandScenario`, for ordinary JUnit tests. Read-model pins, tenant resolution and Chronicle setup are configured on that scenario before the bridge is constructed, and Chronicle scenarios reach the Kotlin extension functions through the generated `ChronicleCommandScenarios` static methods.
