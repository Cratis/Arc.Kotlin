...
Separately again: [development tenant discovery](development-users-and-tenants.md) with `TenantsProvider` answers "which tenants exist" for tools such as [Lens](/tools/lens/), not "which tenant is this request for".
