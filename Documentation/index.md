...
| --- | --- |
| `io.cratis:arc` | Arc commands, queries, authentication, identity, tenancy, introspection, results, and pipelines |
...
| `io.cratis:cratis` | The one dependency for an event-sourced Cratis application - a pure aggregator over Arc, its Spring Boot wiring, and the Chronicle integration |
