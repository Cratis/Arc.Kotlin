...
/** Explicit ordered aggregate of values produced by a command's `provide` method. */
public class CommandProvidedValues(values: Collection<Any>) {
    ...
    public class Builder {
        ...
        public fun build(): CommandProvidedValues = CommandProvidedValues(values)
    }

    public companion object {
        /** Creates an aggregate from ordered [values]. */
        @JvmStatic
        public fun of(vararg values: Any): CommandProvidedValues = CommandProvidedValues(values.asList())
