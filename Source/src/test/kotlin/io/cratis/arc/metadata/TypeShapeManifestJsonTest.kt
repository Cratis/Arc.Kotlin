...
internal class TypeShapeManifestJsonTest {
    ...
    @Test
    fun `format 7 manifest round trip uses only canonical shape metadata`() {
        val shape = nestedShape()
        ...
        assertEquals(ArcArtifactManifest.CURRENT_FORMAT_VERSION, tree.path("formatVersion").intValue())
